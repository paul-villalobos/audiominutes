-- =======================================
-- VoxCliente - Esquema Base de PostgreSQL
...
CREATE TABLE IF NOT EXISTS clients (
    ...
    user_email VARCHAR(255) NOT NULL REFERENCES user_profiles(email) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS meetings (
    ...
    transcript_id UUID UNIQUE NOT NULL,    -- ID interno (para relacionar con otros sistemas)
    assemblyai_id TEXT UNIQUE NOT NULL,    -- ID real devuelto por AssemblyAI
